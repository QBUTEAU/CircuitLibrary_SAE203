...
<body>
    ...
    <section>
        <div id="accueil">
            <div id="titre-texte">
                <strong>SUPPRESSION D'UN CIRCUIT</strong>
            </div>
        </div>
        <?php
        ...
        $req = "DELETE FROM circuits WHERE circuit_id = $suppCircuit";

        // cette ligne sert juste pour le debug. à supprimer quand tout marche correctement 
    
        $mabd->query($req);

        echo "<div class=phrase-resultat><p>Vous venez de supprimer le circuit numéro $suppCircuit.</p>";
